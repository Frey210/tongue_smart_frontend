...
function Results({ accessToken, role, initialSessionId, onUnauthorized }: { accessToken: string; role: Role; initialSessionId: string; onUnauthorized: () => void }) {
  ...
  const resultUnit = results?.points[0]?.unit ?? "unit";
